...
import 'package:delicious_menu/detailpage/populardetail.dart';
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const Populardetail()));
        },
        child: Container(
          width: 150,
          height: 200,
                  ...
                  child: Row(
                    children: [
                      ClipRRect(
                          ...
                          child: const Image(
                              image:
                                  AssetImage('assets/images/japan food1.png'),
                              width: 25,
                              height: 25,
                              fit: BoxFit.cover)),
